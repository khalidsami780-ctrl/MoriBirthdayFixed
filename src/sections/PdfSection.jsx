      ...
      >
        ...
        <motion.div variants={item} style={S.cardOuter}>
          ...
          <div style={S.cardInner}>
            ...
            <motion.p variants={item} style={S.desc}>
              {'ضيفت خانة اسمها رسائل هتلاقي فيها فى كل فترة رسائل ونصائح \n هحافظ على الويبسايت بس لو اختفى يبقى من السيرفر و اللي بينا اكير من ويبسايت يا مريم \n حافظي على قلبك ونفسك ومشاعرك \n و هنفضل ندعي لبعض و انا هفضل ادعي ان لو لينا خير مع بعض ربنا يجمعنا \n لو لقيتي الويبسايت مش محمل حاجة او معلق اعملي ريفريش هتظهر الصفحة '}
            </motion.p>

            <motion.p variants={item} style={S.desc}>
              {`هفضل ابعتلك فى رسايل ونصائح كل فترة وبردو خصوصا فى تواريخنا المفضلة\n بدعيلك من كل قلبي ان ربنا يهون عليكي هذا البعد و أن يرزقنا اللي فيه الخير`}
            </motion.p>
