...
export const advicePosts = [
    ...
    content: `الجزء الاول من الخطة اسمعي الفيديو على 1.5 و مش هوصيكي \n اكتبي وراه وانتي ما شاء الله ملكة الكتابة😊 \n مش عاوزك تقلقي من موضوع اني بكتبلك هنا بس اعتبريه خوفا عليك ونصيحة \n اللي بين كتيير  و كمان الله اعلم يمكن يكون مستقبلنا سوى ف اهو بنساعد بعض  `,
    link: 'https://youtu.be/Zxlw4w9BPjM?si=a45O_z6a0rRhfURd',
    linkLabel: 'الرابط + لا تنسيني من دعواتك',
    date: '2026-03-23',
  },
    ...
    content: `الجزء الثاني من الخطة `,
    link: 'https://youtu.be/UvaDLtO99ks?si=-1xVPARBbJN3v85p',
    linkLabel: 'الرابط + لا تنسيني من دعواتك',
    date: '2026-03-23',
  },
